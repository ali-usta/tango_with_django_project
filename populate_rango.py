...
def populate():
    ...
    python_pages = [
        ...
        {'title': 'Learn Python in 10 Minutes',
         'url': 'http://www.korokithakis.net/tutorials/python/', 'views': 64}]

    django_pages = [
        {'title': 'Official Django Tutorial',
         'url': 'https://docs.djangoproject.com/en/2.1/intro/tutorial01/', 'views': 300},
        {'title': 'Django Rocks',
         'url': 'http://www.djangorocks.com/', 'views': 200},
        {'title': 'How to Tango with Django',
         'url': 'http://www.tangowithdjango.com/', 'views': 100}]

    other_pages = [
        {'title': 'Bottle',
         'url': 'http://bottlepy.org/docs/dev/', 'views': 150},
        {'title': 'Flask',
         'url': 'http://flask.pocoo.org', 'views': 75}]
